...
function library:Window(options)
  ...
  mainDiscord.Name = "mainDiscord"
    ...
    Tab.Position = UDim2.new(0, 120, 0, 4)
	Tab.Size = UDim2.new(0, 370, 0, 25)
	Tab.ZIndex = 5
    ...
    ScrollTab.Size = UDim2.new(0, 330, 0, 30)
    ...
    function Ui:AddTab(options)
        ...
        TabButton.Size = UDim2.new(0, 80, 0, 41)
        TabButton.Position = UDim2.new(0, 100, 0, 50)
		...
		IDK.Position = UDim2.new(0, 1, 0, 0)
        ...
        MainPage.Position = UDim2.new(0.00157977885, 0, 0, 50)
        MainPage.Size = UDim2.new(0, 0, 0, 305)
