...
wait(1)
game:GetService("ReplicatedStorage").SpeedUP.Value = 3
...
M:AddSeperatorLeft("Info")
    M:AddLabelLeft("Wecome To Infinity Hub Script")
    Date = os.date("%d".." ".."%B".." ".."%Y")
...
M:AddLineRight("")
M:AddToggleRight("Auto Replay",_G.AutoReplay,function()
    local args = {
    [1] = "MissionEndInfo"
}
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("Server"):InvokeServer(unpack(args))
 ...
 function UpdateCapp()
    local Iqda = game:GetService("Players").LocalPlayer.PlayerGui.TowerPassRewards.Main.Header.Wrapper.Tier.Wrapper.Container.TierNumber.Text
...
spawn(function()
 ...
 function UpdateC1q()
    local Iqd = game:GetService("Players").LocalPlayer.PlayerGui.TowerPassRewards.Main.Unlocking.Text
    Caq:Set("  "..Iqd)
end
...
spawn(function()
while wait() do
 if  _G.AutoStarPass then
  pcall(function()
local argsz = {
    [1] = "Summon",
    [2] = {
        ["Rotation"] = 0,
        ["cframe"] = CFrame.new(1220.22095, 907.267822, -707.996338, 1, 0, 0, 0, 1, 0, 0, 0, 1),
        ["Unit"] = "Narancia"
    }
}

game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("Input"):FireServer(unpack(argsz))
end)
end
end
end)
...
while wait() do
 if  _G.AutoStarPass then
  pcall(function()
game:GetService("ReplicatedStorage").Remotes.Server:InvokeServer("Upgrade",workspace.Unit.Narancia)
end)
end
end
end)
...
M:AddToggleLeft("Auto Star Paas",_G.AutoStarPass,function(a)
_G.AutoStarPass = a
end)
...
local args = {
    ...
    [2] = {
        ["Rotation"] = 0,
        ["cframe"] = CFrame.new(1237.53394, 907.232849, -699.988525, 1, 0, 0, 0, 1, 0, 0, 0, 1),
...
while wait() do
 if  _G.AutoStarPass2 then
  pcall(function()
      if workspace.Unit["Genos [Overdrive]"].UpgradeTag.Value <= 2 then
game:GetService("ReplicatedStorage").Remotes.Server:InvokeServer("Upgrade",workspace:WaitForChild("Unit"):WaitForChild("Genos [Overdrive]")
)
end
end)
end
