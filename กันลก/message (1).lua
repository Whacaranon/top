...
task.spawn(function()
	game:GetService("RunService").Stepped:Connect(function()
		pcall(function()
			if _G.Settings.Main["Mirage Island"] or _G.Settings.Main["Gear"] or _G.Settings.Main["RaceV4"] or _G.Settings.Main["Auto Find Mirage Island"] then
				if syn then
...
TestTab:AddToggle({
    Name = "TEST",
	Value = _G.AutoMysticIsland2, -- ปรับค่าToggle true/false or Config
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF"):InvokeServer(unpack(args))
            game:GetService("Workspace").Boats.Dinghy.VehicleSeat.MaxSpeed = 350
            if _G.AutoMysticIsland2 == false then
                topostp(CFrame.new(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame))
            end
            end
 ...
 spawn(function()
            while wait() do
                if _G.AutoMysticIsland2 then
                    pcall(function()
                            er(CFrame.new(game:GetService("Workspace").Boats.Dinghy.VehicleSeat.Position))
...
local FM = TestTab:AddLabel({
    Name = "Full Moon : Wait Moon"
})
            ...
            while task.wait() do
                pcall(function()
                    if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149431" then
                        FM:Set("Full Moon : 🌑  5/5")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149052" then
                        FM:Set("Full Moon : 🌒  4/5")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709143733" then
                        FM:Set("Full Moon : 🌓  3/5")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709150401" then
                        FM:Set("Full Moon : 🌗  2/5")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=9709149680" then
                        FM:Set("Full Moon : 🌖  1/5")
                    else
                        FM:Set("Full Moon : 🌚  0/5")
                    end
                end)
            end
        end)
