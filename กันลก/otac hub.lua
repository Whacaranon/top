...
_G.Color = _G.Settings.UI.Color or Color3.fromRGB(0, 255, 255)
local LogoUI = _G.Settings.Logo or "7637477170"
...
function library:Window(options)
  ...
  mainDiscord.Name = "mainDiscord"
    ...
    mainDiscord.MouseButton1Click:Connect(function()
        setclipboard("กูยังไม่มีไอสัส")
        wait(.1)
        game:GetService("StarterGui"):SetCore("SendNotification",{
            Title = "Discord",
            Text = "กูยังไม่มีไอสัส",
            Button1 = "Okay",
            Duration = 20
        })
    end)
